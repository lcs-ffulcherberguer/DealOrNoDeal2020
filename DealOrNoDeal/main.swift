...
//
// MARK: PROCESS SECTION OF PROGRAM
//
...
func getBriefcaseOpened(onTurn turn: Int) -> Int {
    ...
    while true {
        ...
        // INPUT
        guard let inputGiverString = readLine() else {
            func getBriefcaseOpened(onTurn turn: Int) -> Int {
                briefcasesOpened = inputGiven
        }
        ...
        // If we've made it here, the input is valid, so return which briefcase was opened
        return integerGiven
...
//
// MARK: OUTPUT SECTION OF PROGRAM
//
